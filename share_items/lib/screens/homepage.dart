...
import 'package:share_items/screens/client_section.dart';
...
class _HomepageState extends State<Homepage> {
  ...
  final channel =
      WebSocketChannel.connect(Uri.parse('ws://192.168.198.1:2406'));
  var logger = Logger();
  bool online = true;
        ...
        child: ListView(
          children: [
            ElevatedButton(
                ...
                child: const Text('Medical Supply Organizer Section')),
            // ElevatedButton(
            //     onPressed: () {
            //       if (!online) {
